...
### Limite de renderizacao

Todos os usuarios e planos possuem o mesmo limite de **999999 cortes por hora**.

Pedidos de renderizacao nao sao rejeitados com base no tamanho atual da fila de processamento. As protecoes contra render duplicado ou ja em andamento continuam ativas.
