...
<ParamField query="per_page" type="integer">
  Quantidade de itens por pagina (1-20, padrao: 10)
</ParamField>
...
{
  "error": "O per_page deve ser entre 1 e 20."
}
```
</ResponseExample>

<Warning>
Nao existe `GET /projects/{id}` no contrato atual. Para localizar um projeto especifico,
use esta listagem paginada. Se voce tambem precisa dos cortes, `GET /shorts/{projectId}`
retorna o projeto no campo `project` junto da lista de shorts.
</Warning>
