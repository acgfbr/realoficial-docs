...
api: 'GET /projects'
description: 'Liste todos os projetos do usuário autenticado'
---
...
<ParamField query="per_page" type="integer">
  Quantidade de itens por página (1-20, padrão: 10)
</ParamField>
...
<Warning>
Não existe `GET /projects/{id}` no contrato atual. Para localizar um projeto específico,
use esta listagem paginada. Se você também precisa dos cortes, `GET /shorts/{projectId}`
...
<CardGroup cols={2}>
  ...
  <Card title="Concluído" icon="check">
