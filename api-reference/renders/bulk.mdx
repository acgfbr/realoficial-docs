...
- Usuario deve ter um plano ativo
- O limite e de 999999 cortes por hora para todos os planos
- O pedido nao e rejeitado com base no tamanho atual da fila de processamento
...
```json 400 - Limite Horario Atingido
{
...
```json 400 - Plano Ativo Necessario
{
