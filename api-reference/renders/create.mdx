...
Todos os usuários e planos podem solicitar até **999999 cortes por hora**.
...
{
  "error": "Você já gerou 999999 cortes na última hora. Seu plano permite 999999 cortes por hora. Aguarde alguns minutos e tente novamente."
}
```
...
- O limite de 999999 cortes por hora é o mesmo para todos os planos
