...
<Warning>
**Limite de renderizacao por hora:**

Todos os usuarios e planos podem solicitar ate **999999 cortes por hora**.

O endpoint nao rejeita novos pedidos com base no tamanho atual da fila de processamento. As protecoes contra render duplicado ou ja em andamento continuam ativas.
...
<ResponseField name="data" type="object">
  ...
  <Expandable title="Propriedades">
    ...
    <ResponseField name="id" type="string">
      Alias de compatibilidade para `render_id`. Novas integracoes devem preferir
      `render_id` como nome canonico.
    </ResponseField>
...
- O limite de 999999 cortes por hora e o mesmo para todos os planos
