...
Todos os planos podem solicitar até **50 cortes por hora**, exceto o plano **Business**, que possui renderizações ilimitadas.
...
{
  "error": "Você já gerou 50 cortes na última hora. Seu plano permite 50 cortes por hora. Aguarde alguns minutos e tente novamente."
}
```
...
- O limite é de 50 cortes por hora; no plano Business, as renderizações são ilimitadas
